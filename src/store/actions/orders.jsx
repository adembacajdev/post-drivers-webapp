import {
    ...
    DELETE_ORDERS, GET_TOP_CITIES, GET_TOP_PRODUCTS
} from '../actionTypes';
...
export const getAllOrders = () => async (dispatch) => {
    try {
        ...
        if (data.success) dispatch({ type: GET_ALL_ORDERS, data });
    } catch (e) {
...
export const getOrder = (id) => async (dispatch) => {
    try {
        ...
        if (data.success) dispatch({ type: GET_ORDER, data });
    } catch (e) {
        return Promise.reject(e);
    }
}
...
export const getNumberOfOrdersByStatus = () => async (dispatch) => {
    try {
        ...
        if (data.success) dispatch({ type: NUMBER_OF_ORDERS_BY_STATUS, data });
    } catch (e) {
        return Promise.reject(e);
    }
}
...
export const postOrder = (body) => async (dispatch) => {
    try {
        ...
        if (data.success) dispatch({ type: POST_ORDER, data });
    } catch (e) {
        return Promise.reject(e);
    }
}
...
export const getOrderByStatus = (status) => async (dispatch) => {
    try {
        ...
        if (data.success) dispatch({ type: GET_ORDER_BY_STATUS, data });
    } catch (e) {
        return Promise.reject(e);
    }
}
...
export const getOrderByCity = (city) => async (dispatch) => {
    try {
        ...
        if (data.success) dispatch({ type: GET_ORDERS_BY_CITY, data });
    } catch (e) {
        return Promise.reject(e);
    }
}
...
export const getTopCities = () => async (dispatch) => {
    try {
        ...
        if (data.success) dispatch({ type: GET_TOP_CITIES, data });
    } catch (e) {
        return Promise.reject(e);
    }
}
...
export const getTopProducts = () => async (dispatch) => {
    try {
        ...
        if (data.success) dispatch({ type: GET_TOP_PRODUCTS, data });
    } catch (e) {
        return Promise.reject(e);
    }
}
...
export const deleteOrder = (id) => async (dispatch) => {
    try {
        ...
        if (data.success) dispatch({ type: DELETE_ORDER, data });
    } catch (e) {
        return Promise.reject(e);
    }
}
...
export const deleteProducts = (order_ids) => async (dispatch) => {
    try {
        ...
        if (data.success) dispatch({ type: DELETE_ORDERS, data });
    } catch (e) {
        return Promise.reject(e);
    }
}